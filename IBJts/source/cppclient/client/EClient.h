...
const std::set<int> PROTOBUF_MSG_IDS = { REQ_EXECUTIONS };
...
private:
	void reqExecutionsProtoBuf(int reqId, const ExecutionFilter& filter);
	void reqExecutionsNonProtoBuf(int reqId, const ExecutionFilter& filter);
