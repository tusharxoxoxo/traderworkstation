...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 25, sizeof(::protobuf::Execution)},
};
...
const char descriptor_table_protodef_Execution_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017Execution.proto\022\010protobuf\"\357\005\n\tExecutio"
  ...
  "(\010H\022\210\001\001\022\026\n\tsubmitter\030\024 \001(\tH\023\210\001\001B\n\n\010_orde"
  "rIdB\t\n\007_execIdB\007\n\005_timeB\r\n\013_acctNumberB\013"
  "\n\t_exchangeB\007\n\005_sideB\t\n\007_sharesB\010\n\006_pric"
  "eB\t\n\007_permIdB\013\n\t_clientIdB\020\n\016_isLiquidat"
  "ionB\t\n\007_cumQtyB\013\n\t_avgPriceB\013\n\t_orderRef"
  ...
  "PendingB\014\n\n_submitterB(\n\026com.ib.client.p"
  "rotobufB\016ExecutionProtob\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Execution_2eproto = {
  false, false, descriptor_table_protodef_Execution_2eproto, "Execution.proto", 831,
...
Execution::Execution(const Execution& from)
  ...
  ::memcpy(&orderid_, &from.orderid_,
    static_cast<size_t>(reinterpret_cast<char*>(&lastliquidity_) -
    reinterpret_cast<char*>(&orderid_)) + sizeof(lastliquidity_));
...
void Execution::SharedCtor() {
  ...
  ::memset(&orderid_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&lastliquidity_) -
      reinterpret_cast<char*>(&orderid_)) + sizeof(lastliquidity_));
}
...
// @@protoc_insertion_point(message_clear_start:protobuf.Execution)
  ...
  if (cached_has_bits & 0x000f0000u) {
    ::memset(&evmultiplier_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&lastliquidity_) -
        reinterpret_cast<char*>(&evmultiplier_)) + sizeof(lastliquidity_));
  }
  _has_bits_.Clear();
...
void Execution::InternalSwap(Execution* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Execution, lastliquidity_)
      + sizeof(Execution::lastliquidity_)
